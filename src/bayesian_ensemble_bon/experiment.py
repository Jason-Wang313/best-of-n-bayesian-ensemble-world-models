...
def _write_generated_results(path: Path, summary: list[dict[str, float | int | str]], config: ExperimentConfig) -> None:
    ...
    macros = {
        ...
        "MeanHighRegret": value(high_n, "mean_bon", "regret_to_candidate_oracle"),
        ...
        "SampleHighStd": value(high_n, "posterior_sample_bon", "selected_pred_std"),
        "SampleHighSampleGap": value(high_n, "posterior_sample_bon", "sample_over_mean"),
